...
<?php endif; ?>
	...
	<div id="edit_product"><?php _e('You are logged in:', 'orderstorm-wordpress-e-commerce'); ?> <a href="https://www.orderstorm.com/osa/productEdit/<?php orderstorm_ecommerce('product', 'guid'); ?>/general" target="_blank"><?php _e('Edit this product', 'orderstorm-wordpress-e-commerce'); ?></a> | <a href="javascript:void(0);" class="add_images">Add images</a></div>
